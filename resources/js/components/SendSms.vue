        ...
        <card class="mb-6">
            ...
            <div>
                <div class="flex border-b border-40">
                    ...
                    <div class="w-1/2 px-8 py-6">
                        <select name="country" v-model="country" class="w-full form-control form-select">
...
<script>
    export default {
        ...
        methods: {
            sendSMS() {
                if (! this.body.length || ! this.country.length || ! this.to.length) {
                    this.$toasted.show('Please fill all of the fields.', {type: 'error'})
                    return false
                }
