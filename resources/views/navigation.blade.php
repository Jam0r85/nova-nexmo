...
<ul class="list-reset mb-8">
    <li class="leading-wide mb-4">
        <router-link :to="{
                            name: 'index',
                            params: {
                                resourceName: 'text-messages'
                            }
                        }" class="text-white ml-3 no-underline dim">
                            SMS History
        </router-link>
    </li>
    <li class="leading-wide mb-4">
        <router-link :to="{name: 'nova-nexmo-send-sms'}" class="text-white ml-3 no-underline dim">
            Send SMS
        </router-link>
    </li>
</ul>